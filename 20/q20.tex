...
(\romannumeral1) Let E be the event that the sum is 7.
\begin{align}
\Pr(E) &= Pr(X+Y=7) \\
&= \frac{7-1}{36} \\
&= \frac{1}{6}
...
(\romannumeral2) Let F be the event that the sum is a prime number.
\begin{align}
...
(\romannumeral3) Let G be the event that the sum is 1. Then,
\begin{align}
\Pr(G) &= \Pr(X+Y=1) \\
&= 0
\end{align}
